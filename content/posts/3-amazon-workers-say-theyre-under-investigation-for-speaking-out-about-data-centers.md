...
1. **Retaliatory Actions** – Demotions, pay cuts, and terminated contracts after public statements on social media or internal forums.
2. **Discriminatory Policies** – Internal policies that allegedly discourage or penalize “politically active” employees.
3. **Failure to Provide Safe Reporting Channels** – Lack of confidential mechanisms for reporting political retaliation.
...
1. **Complaint Filing** – Engineers submit evidence (emails, internal memos, social media posts).
2. **Preliminary Review** – The office screens for jurisdictional relevance.
3. **Formal Investigation** – Interviews, document requests, and potential subpoenas.
4. **Mediation or Litigation** – Depending on findings, the office may negotiate a settlement or refer to the state court.
